...
namespace frmMain
{
    public partial class frmProductSelect : Form
    {
        ...
        public frmProductSelect(frmLogin frmLogin,String staffCode, String staffAuthority)
        {
            InitializeComponent();
            _frmLogin = frmLogin;
        ...
        private void frmProductSelect_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void dgvProduct_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtSize.Text = dgvProduct.Rows[numRow].Cells[5].Value.ToString().Trim();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            //Nếu đầy đủ thông tin cần nhập
            {
                ...
                else
                {
                    ...
                    //Kiểm tra nếu mặt hàng đã được chọn
                    foreach(ListViewItem listViewItem in lvSelectedProducts.Items)
                    {
                        if (listViewItem.SubItems[1].Text.Trim() == pdCode)
                        {
                            MessageBox.Show("Mặt hàng đã được chọn!", "Trùng mặt hàng", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            return;
                        }
                    }
        ...
        {
            frmBillConfirmation frmBillConfirmation = new frmBillConfirmation();
            frmBillConfirmation.ShowDialog();
        }
